...
import package_one.*;
public class Methods_adv extends Methods_basic
{
    public void retrieve_data_id(String[] args)//displays data of a district for a given id
    {
        List<Data> temp=new ArrayList<>();
        
        final String SQL="select * from ts_districts where id=?";
    ...
    public void retrieve_data_zone(String[] args)//displays data of all districts in a given zone
    {
        ...
        final String SQL="select * from ts_districts where zone=?";
    ...
    public void retrieve_data_tc(String[] args)//displays data of all districts with total cases greater than given total cases by user
    {
        ...
        final String SQL="select * from ts_districts where totalCases>?";
    ...
    {
        final String SQL="select avg(NewCasesDay) as average from ts_districts";
    ...
    {
        final String SQL="select zone,sum(totalCases) as totalcases from apstates group by zone";
